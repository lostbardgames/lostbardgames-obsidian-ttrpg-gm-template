module.exports = async (params) => {
  ...
  const name = await qa.inputPrompt("New Adventure", "Enter adventure name...");
  if (!name) return;

  const destPath = `Campaign/Parties/Adventures/${name}.md`;
  ...
  if (!tpl) { new Notice("Adventure template not found!"); return; }
