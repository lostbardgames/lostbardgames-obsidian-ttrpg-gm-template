...
const SYSTEMS = [
    {
        ...
        description: "No system-specific rules — works with any TTRPG",
        icon: "🎲",
        pcTemplate: "z_Templates/Systems/agnostic/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
            "Campaign/Lore/Events",
        ],
        loreButtonsId: "agnostic",
        importButtons: [],
        characterTypeLabel: null,
        classLabel: null,
    },
    {
        id: "dnd5e",
    ...
    {
        id: "dnd5e_2024",
        name: "D&D 5th Edition (2024 / One D&D)",
    ...
    {
        id: "pf1e",
        name: "Pathfinder 1st Edition / D&D 3.5",
        description: "Pathfinder 1e or D&D 3.5e — BAB, three saves, skill ranks, archetypes",
        icon: "🏹",
        pcTemplate: "z_Templates/Systems/pf1e/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Races",
            "Campaign/Lore/Classes",
            "Campaign/Lore/Classes/Archetypes",
            "Campaign/Lore/Backgrounds",
            "Campaign/Lore/Feats",
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
    ...
    },
    {
        ...
        description: "CoC 7e — Investigators, Occupations, percentile skills, and Sanity",
        icon: "🐙",
        pcTemplate: "z_Templates/Systems/coc7e/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Occupations",
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
            "Campaign/Lore/Events",
        ],
        loreButtonsId: "coc7e",
        importButtons: [],
        characterTypeLabel: "Occupation",
        classLabel: null,
    },
    {
        id: "vtm5",
        name: "Vampire: The Masquerade 5th Edition",
        description: "VtM 5e — Clans, Disciplines, Hunger, Humanity, and the Masquerade",
        icon: "🩸",
        pcTemplate: "z_Templates/Systems/vtm5/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Clans",
            "Campaign/Lore/Disciplines",
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
            "Campaign/Lore/Events",
        ],
        loreButtonsId: "vtm5",
        importButtons: [],
        characterTypeLabel: "Clan",
        classLabel: null,
    },
    {
        id: "starfinder",
        name: "Starfinder 1st Edition",
        description: "Starfinder 1e — Sci-fi adventure, Themes, Stamina/HP/Resolve, starship combat",
        icon: "🚀",
        pcTemplate: "z_Templates/Systems/starfinder/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Species",
            "Campaign/Lore/Classes",
            "Campaign/Lore/Classes/Archetypes",
            "Campaign/Lore/Themes",
            "Campaign/Lore/Feats",
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
            "Campaign/Lore/Events",
        ],
        loreButtonsId: "starfinder",
        importButtons: [],
        characterTypeLabel: "Species",
        classLabel: "Class",
    },
    {
        ...
        description: "SWADE — Die-based attributes, Edges & Hindrances, fast and furious play",
        icon: "🎴",
        pcTemplate: "z_Templates/Systems/swade/Template - Player Character.md",
        loreFolders: [
            "Campaign/Lore/Races",
            "Campaign/Lore/Archetypes",
            "Campaign/Lore/Edges",
            "Campaign/Lore/Hindrances",
            "Campaign/Lore/Conditions",
            "Campaign/Lore/Languages",
            "Campaign/Lore/Events",
        ],
